...
**Bottleji Backend** - A NestJS-based backend for the Bottleji recycling application.

This backend provides APIs for:
- User authentication and management
- Drop creation and collection
...
- `scripts/admin/` - Admin dashboard utilities
- `scripts/testing/` - API testing utilities
