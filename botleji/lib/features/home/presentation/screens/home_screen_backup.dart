...
//       floatingActionButton: !_isLoading && _errorMessage == null && currentIndex == 0
//           ? ref.watch(userModeControllerProvider).when(
...
//                         // Don't lock form when using current location
//                         _isLocationLocked = false;
//                       } else {
//                         // Lock form only when user wants to set custom location
...
//                   elevation: 0,
//                 child: Container(
//                     height: 300, // Increased map height for better interaction
//                   decoration: BoxDecoration(
...
//                               // Lock form when user is moving the camera (panning/zooming) and not using current location
...
//                               print('Form locked - tap Confirm when ready');
//                             },
//                             markers: {
//                               Marker(
...
//                                 icon: BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueRed), // Red marker for better visibility
//                                 anchor: const Offset(0.5, 1.0), // Center the marker on the location
...
//                                     _selectedLocationAddress = address;
//                                   });
//                                   print('Pin dragged to: ${newPosition.latitude}, ${newPosition.longitude}');
//                                 },
//                                 onDragStart: (_) {
//                                   setModalState(() {
//                                     _useCurrentLocation = false; // Switch to custom location when dragging
//                                     _isLocationLocked = true;
//                                   });
//                                   print('Pin dragging started - Form locked');
//                                   print('_isLocationLocked: $_isLocationLocked');
//                                 },
//                                 onDrag: (newPosition) {
...
//                             zoomGesturesEnabled: true,
//                             scrollGesturesEnabled: true,
//                             rotateGesturesEnabled: false, // Disable rotation for simpler interaction
//                             tiltGesturesEnabled: false, // Disable tilt for simpler interaction
//                             myLocationEnabled: true,
//                             myLocationButtonEnabled: false, // Disable the repositioning button
...
//                                     _isLocationLocked = false;
//                                   });
//                                   print('Location confirmed: ${_selectedDropLocation?.latitude}, ${_selectedDropLocation?.longitude}');
//                                   print('Form unlocked - you can now scroll and complete the form');
//                                 },
//                                 backgroundColor: Theme.of(context).colorScheme.primary,
//                                 foregroundColor: Theme.of(context).colorScheme.onPrimary,
...
//                                 setModalState(() {
//                                   _bottleType = value;
//                                   // Reset only the relevant count when type changes
...
//                         // Dynamic bottle number inputs based on type
...
//                                         try {
//                                           print('🔍 Accepting drop from home: ${drop.id}');
...
//                                             ScaffoldMessenger.of(context).showSnackBar(
//                                               const SnackBar(
//                                                 content: Text('Please log in to accept drops'),
//                                                 backgroundColor: Colors.red,
//                                               ),
//                                             return;
//                                           }
...
//                                               .assignCollector(drop.id, userId);
...
//                                             collectorId: userId, // Add collector ID (userId)
...
//                                           );
//                                           // Refresh drops
//                                           ref.read(dropsControllerProvider.notifier).loadDropsAvailableForCollectors();
//                                         } catch (e) {
...
//                                             ));
//                                         }
//                                       icon: Icon(hasActiveCollection ? Icons.block : Icons.navigation),
//                                       label: Text(hasActiveCollection ? 'Complete Current Drop First' : 'Start Navigation'),
//                                       style: FilledButton.styleFrom(
//                                         backgroundColor: hasActiveCollection ? Colors.grey : Colors.blue,
//                                         foregroundColor: Colors.white,
...
//   // Debounced map rebuild to prevent rapid rebuilds
